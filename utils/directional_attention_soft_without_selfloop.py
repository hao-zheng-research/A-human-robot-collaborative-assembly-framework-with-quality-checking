...
def calculate_attention_scores(input_tensor, num_prev_frames=5):
    ...
    attention_map_left_hand = torch.cat((attention_map_left_hand[:, :49], attention_map_left_hand[:, 51:]), dim=1)
    attention_map_right_hand = torch.cat((attention_map_right_hand[:, :49], attention_map_right_hand[:, 51:]), dim=1)
    ...
    return attention_map_left_hand*52, attention_map_right_hand*52